    ...
    class Batalha:
        ...
        def battle(self):
            ...
            while(self.monstro.vida > 0 or self.jogador.vida > 0):
                ...
                if self.manobra_escolhida.tipo == Manobra.ATAQUE:
                ...
                if self.manobra_escolhida.tipo == Manobra.CURA:
                ...
                if self.manobra_escolhida.tipo == Manobra.ESPERAR:
...
label start:
    ...
    default ataque_simples = Ataque("Ataque Simples", 30, Manobra.ATAQUE, 5, "punhos" )
    default magia_cura = Ataque("Cura Simples", 5, Manobra.CURA, 0, "Magia de Cura")
    default magia_cura_2 = Ataque("Cura", 10, Manobra.CURA, 0, "Magia de Cura reforçada")
    default magia_fogo = Ataque("Bola de Fogo", 40, Manobra.ATAQUE, 10, "bola de fogo")
    default esperar = Ataque("Esperar", 0, Manobra.ESPERAR, 0, "Aguardar")
...
screen stats:
    frame:
        ...
        yalign 0.65
        vbox:
            textbutton "Atacar" action Show("manobras")
            textbutton "Item" action NullAction()
            textbutton "Fugir" action NullAction()
    ...
    frame:
        ...
        vbox:
            for ataque in hero.ataques:
                textbutton ataque.name action SetVariable("batalha.manobra_escolhida", ataque), Hide("manobras"), Return()
    frame:
        xalign 0.5
        yalign 0.9
        textbutton "Voltar" action Hide("manobras")
